...
@interface HomePageViewController ()<ZHBWaterFallViewDatasource,ZHBWaterFallViewDelegate,ZHBRefreshScrollViewDelegate>{
...
- (ZHBWaterFallViewCell *)waterFallView:(ZHBWaterFallView *)waterFallView cellAtIndex:(NSInteger)index{
    ...
    HomePageWaterFallCell *cell = [waterFallView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (!cell) {
        cell = [[HomePageWaterFallCell alloc] initWithIdentifier:cellIdentifier];
...
- (void)waterFallView:(ZHBWaterFallView *)waterFallView didSelectAtIndex:(NSInteger)index{
    ...
    HomePageDetailViewCoontroller *detailViewController = [[HomePageDetailViewCoontroller alloc] init];
...
-(ZHBWaterFallView *)waterFallView{
    if (!_waterFallView) {
        ...
        waterFallView.pullDistance = 100;
